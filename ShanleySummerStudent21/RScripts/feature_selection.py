...
def selectFeatures(RNA_data, file_name):
    ...
    RNA_t.to_csv("../Early Detection/Data/" + file_name)
    print("saved file", file_name)


mRNA_data = pd.read_csv(r"../Early Detection/Data/mRNA_train.csv")
miRNA_data = pd.read_csv(r"../Early Detection/Data/mRNA_train.csv")

selectFeatures(mRNA_data, "sig_mRNA_train.csv")
selectFeatures(miRNA_data, "sig_miRNA_train.csv")
